...
describe("RecommendationRequestTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    // instead of hard coding id, derive from recommendationRequestFixtures threeRequests
    recommendationRequestFixtures.threeRequests.forEach((item, index) => {
      expect(
        screen.getByTestId(`${testId}-cell-row-${index}-col-id`),
      ).toHaveTextContent(String(item.id));
    });
