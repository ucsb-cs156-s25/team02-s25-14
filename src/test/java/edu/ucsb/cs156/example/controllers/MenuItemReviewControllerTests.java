...
public class MenuItemReviewControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_menuitemreviews() throws Exception {
                ...
                MenuItemReview menuItemReview2 = MenuItemReview.builder()
                            .itemId(30)
                            .stars(5)
                            .reviewerEmail("shru@gmail.com")
                            .dateReviewed(ldt2)
                            .comments("best food ever")
                            .build();
        ...
        public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/MenuItemReview/post?itemId=23&stars=3&reviewerEmail=sbd@gmail.com&dateReviewed=2022-01-03T00:00:00&comments=could've been better")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_delete_a_review() throws Exception {
                ...
                // act
                MvcResult response = mockMvc.perform(
                                delete("/api/MenuItemReview/delete?id=15")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
