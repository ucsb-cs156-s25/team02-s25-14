...
public class UCSBOrganizationIT {
        ...
        public void test_that_logged_in_user_can_get_by_orgcode_when_the_orgcode_exists() throws Exception {
                ...
                ucsborganizationRepository.save(ucsborganizations1);
        ...
        public void an_admin_user_can_post_a_new_ucsborganization() throws Exception {
                ...
                UCSBOrganization ucsborganizations1 = UCSBOrganization.builder()
                        .orgCode("kbf")
                        .orgTranslationShort("KBFans")
                        .orgTranslation("Kevin Burk Fans")
                        .inactive(false)
                        .build();

                // act
                MvcResult response = mockMvc.perform(
                                post("/api/ucsborganizations/post?orgCode=kbf&orgTranslationShort=KBFans&orgTranslation=Kevin Burk Fans&inactive=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
